...
class MergeDeep {
  ...
  compareDeep (t, s, additions, modifications, deletions) {
    ...
    this.log.debug('compareDeep begin BaseConfig %o', target)
    this.log.debug('compareDeep begin OverrideConfig %o', source)
    ...
    if (t === undefined || t === null || (this.isEmpty(t) && !this.isEmpty(s))) {
      ...
      this.log.debug('compareDeep end BaseConfig %o', target)
      this.log.debug('compareDeep end OverrideConfig %o', source)
